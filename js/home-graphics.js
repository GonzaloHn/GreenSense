...
var line_chart_energy = new Dygraph(document.getElementById("graph-energy"), data_energy, {width:500, color:"yellow"}); //crea el nuevo grafico
var line_chart_air = new Dygraph(document.getElementById("graph-air"), data_air, {width:500, color:"blue"}); //crea el nuevo grafico
var line_chart_weight = new Dygraph(document.getElementById("graph-weight"), data_weight, {width:500, color:"red"}); //crea el nuevo grafico
